...
NameFr=['Hiver','Printemps','Été','Automne']
period=['2011-2040']
...
##########################################################
    ...
    #    crs=ccrs.PlateCarree()
       ...
       # mycmap.set_over("darkred") 
        ...
        cbar = plt.colorbar(mm,  shrink=0.75, drawedges='True', ticks=np.arange(-5.0, 5.1, 0.5), extend='both',label='°C')
        ...
        string_title=u'Anomalies saisonnières de la température moyenne\n '+NameFr[i]+' RCP8.5 '+period[t]        
