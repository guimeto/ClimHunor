...
plt.title('Anomalies interannuelles de la température minimale\n', fontsize=20, color='black', weight='semibold')
...
plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_17_20/VI_YEAR_Mean_tasmin.png', bbox_inches='tight', format='png', dpi=1000)
plt.show()  
plt.close()
