...
plt.title('Anomalies interannuelles de la température maximale\n', fontsize=20, color='black', weight='semibold')
for label in ax1.get_yticklabels():
    label.set_fontsize(20)
...
ax2.text(-0.5, 3 , "°C", ha='center', va='bottom', fontsize=20, color='black', weight='semibold', rotation=90) 
...
plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_17_20/VI_YEAR_Mean_tasmax.png', bbox_inches='tight', format='png', dpi=1000)    
plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figure3/VI_YEAR_Mean_tasmax.png', bbox_inches='tight', format='png', dpi=1000)
plt.show()  
plt.close()
