...
########################  OUVERTURE DU CHAMPS A LIRE  ########
        rep1='K:/PROJETS/PROJET_CORDEX/CORDEX-NAM44/MOYENNE_ENSEMBLE/MOIS/Mean_tasmax/'
...
##########################################################
    ...
    #    crs=ccrs.PlateCarree()
       ...
       # mycmap = mpl.cm.get_cmap('jet', 40)
        ...
        cbar = plt.colorbar(mm,  shrink=0.75, drawedges='True', ticks=np.arange(-14, 15.0, 1.0), extend='both',label='°C')
        ...
        string_title=u'Climatologie de la température maximale en janvier\n 2041-2070 RCP8.5'        
        plt.title(string_title, size='xx-large')       
        plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figure5/climatology_ensemble_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_'+str(i)+'.png', bbox_inches='tight', pad_inches=0.1)
        plt.show()  
        plt.close()
