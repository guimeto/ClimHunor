...
##########################################################
    ...
    #    crs=ccrs.PlateCarree()
       ...
       # mycmap = mpl.cm.get_cmap('jet', 40)
        ...
        cbar = plt.colorbar(mm,  shrink=0.75, drawedges='True', ticks=np.arange(-20, 21.0, 1.0), extend='both',label='°C')
        ...
        plt.xlabel(u'\n\n\nClimatology of Mean_tasmax (Celcius) ',size='x-large')        
        #string_title=u'Climatologie annuelle de la température maximale journalière (Celcius) \n Moyenne d\'ensemble de '+nb_model[s]+' RCMs RCP8.5 ('+period[t]+')\n\n' 
        string_title=u'Climatologie annuelle de la température maximale\n 2071-2100 RCP8.5' 
        plt.title(string_title, size='xx-large')       
        plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_8-11/climatology_ensemble_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_YEAR.png', bbox_inches='tight', pad_inches=0.1)
        #plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figure5/climatology_ensemble_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_YEAR.png', bbox_inches='tight', pad_inches=0.1)
