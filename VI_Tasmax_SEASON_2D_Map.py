...
for s in list_saison:
    ...
    if s == 'DJF':        
        title='Anomalies saisonnières de la température maximale en hiver\n '
    elif s == 'MAM':        
        title='Anomalies saisonnières de la température maximale au printemps\n '
    elif s == 'JJA':        
        title='Anomalies saisonnières de la température maximale en été\n '
    elif s == 'SON':        
        title='Anomalies saisonnières de la température maximale en automne\n '
    ...
    plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_17_20/VI_SEASON_'+s+'_Mean_tasmax.png', bbox_inches='tight', format='png', dpi=1000)
    plt.show()  
    plt.close()
