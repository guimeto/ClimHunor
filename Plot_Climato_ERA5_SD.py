...
nc_fid=Dataset('J:/REANALYSES/ERA5/SWE_Cumul_Nittasinan/climato/ERA5_Cumul_SWE_climatology_1990-2019.nc','r')
...
cbar = plt.colorbar(mm,  shrink=1.0, drawedges='True', ticks=np.arange(10, 30., 2),extend='both')
...
string_title=u'Climatologie de l\'épaisseur de neige cumulée entre le 1er novembre et le 31 mars \n Période de référence 1990-2019\n'
plt.title(string_title, size='xx-large')
plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_Ann_Everitt/ERA5_Snow_Depth_CLIM_1990-2019.png', bbox_inches='tight', pad_inches=0.1)
plt.show() 