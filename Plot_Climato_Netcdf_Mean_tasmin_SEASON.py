...
##########################################################
    ...
    #    crs=ccrs.PlateCarree()
       ...
       # mycmap = mpl.cm.get_cmap('jet', 40)
        ...
        cbar = plt.colorbar(mm,  shrink=0.75, drawedges='True', ticks=np.arange(0, 20.0, 1.0), extend='both',label='°C')
        ...
        string_title=u'Climatologie saisonnière de la température minimale \n en été '+period[t]+' RCP8.5 \n'        
