...
nc_fid=Dataset('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/mkopw_mpw/codes/Cumul_SWE/ERA5_Land_Cumul_SWE_1981-2019.nc','r')
data=nc_fid.variables['Cumul_SWE'][:].squeeze()
...
cbar = plt.colorbar(mm,  shrink=1.0, drawedges='True', ticks=np.arange(0, 1., 0.1),extend='both')
...
string_title=u'Tendances Mann Kendall des anomalies de l\'épaisseur de neige [mm] au 31 mars \n Période de référence 1981-2010\n'
plt.title(string_title, size='xx-large')
plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figures_Ann_Everitt/ERA5_Snow_Depth_31_mars_tendances_anomalies_1981-2019.png', bbox_inches='tight', pad_inches=0.1)
plt.show() 