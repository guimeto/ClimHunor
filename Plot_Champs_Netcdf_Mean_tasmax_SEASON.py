...
########################  OUVERTURE DU CHAMPS A LIRE  ########
        rep1='K:/PROJETS/PROJET_CORDEX/CORDEX-NAM44/ANOMALIE_ENSEMBLE/SAISON/Mean_tasmax/'
        rep2='anomalie_ensemble_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_1971-2000_'+Saison[i]+'.nc'
        filename=rep1+rep2
...
########################  OUVERTURE DU CHA MPS SIGNIFICATIF  ########
        rep3='K:/PROJETS/PROJET_CORDEX/CORDEX-NAM44/ANOMALIE_ENSEMBLE/SAISON/SIGNIFICATIF_sigma/Mean_tasmax/'
        rep4='anomalie_ensemble_60percent_significatif_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_1971-2000_'+Saison[i]+'.nc'
        filename=rep3+rep4
        nc_fid=Dataset(filename,'r')  
        lats = nc_fid.variables['lat'][:]  # Extrait et copie les données du fichier NetCDF
        lons = nc_fid.variables['lon'][:]
...
##########################################################
    ...
    #    crs=ccrs.PlateCarree()
       ...
       # mycmap.set_over("darkred") 
        ...
        string_title=u'Anomalies saisonnières de la température maximale\n '+NameFr[i]+' RCP8.5 '+period[t]        
        plt.title(string_title, size='xx-large')       
        plt.savefig('K:/PROJETS/PROJET_CLIMHUNOR/Atlas/Atlas_figures/figure_12-15/anomalie_ensemble_'+nb_model[s]+'_RCMs_Pilotes_GCMs_'+scenario[s]+'_CORDEX_NAM44_ll_Mean_tasmax_'+period[t]+'_1971-2000_'+Saison[i]+'.png', bbox_inches='tight', pad_inches=0.1)
        plt.show()  
        plt.close()
